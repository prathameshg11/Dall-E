  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[14px] max-w-[700px]'>Create imaginative ans visually stunning images through DALL-E AI and share them with the Community</p>
      </div>
